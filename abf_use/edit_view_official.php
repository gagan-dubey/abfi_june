                ...
                <div class="col-lg-12">
                    ...
                    <p><button style="width:30px; height:25px;" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal1"><i class="fa fa-image fa-fw"></i></button>
                              ...
                              <img src="../abf_use/off_reg_imgs/<?php echo $image;?>" alt="Player-Image" width="150" height="150"/>
									...
									<div class="col-lg-3">
									<div class="col-lg-7"><label>Blood Group</label></div>
									<div class="col-lg-5"><input class="form-control" name="blood" value="<?php echo "$f";?>"></div>
									</div>
									...
									<div class="col-md-10"><textarea class="form-control" name="address" rows="6" style="resize: none;"><?php echo "$i";?></textarea></div>
									</div>
									<div class="col-md-6">
											<div class="row">
											<div class="col-md-3"><label>District</label></div>
											<div class="col-md-7"><input class="form-control" name="district" value="<?php echo "$k";?>"></div>
											</div></br>
											
											<div class="row">
											<div class="col-md-3"><label>State</label></div>
											<div class="col-md-7"><input class="form-control" name="state" value="<?php echo $single_offc_dets->get_state_name($l);?>" readonly></div>
											</div></br>
											
											<div class="row">
											<div class="col-md-3"><label>Post code</label></div>
											<div class="col-md-7"><input class="form-control" name="postalcode" value="<?php echo "$j";?>"></div>
											</div>
									...
									<div class="col-lg-4">
									<div class="col-md-4"><label>Aadhar</label></div>
									<div class="col-md-8"><input class="form-control" name="aadhar" value="<?php echo "$n";?>"></div>
									</div>
									
									<div class="col-lg-4">
									<div class="col-lg-4"><label>Passport</label></div>
									<div class="col-lg-8"><input class="form-control" name="passport" value="<?php echo "$o";?>"></div>
									</div>
									...
									<div class="col-lg-6">
									<div class="col-lg-4"><label>Marriage Date</label></div>
									<div class="col-lg-8"><input class="form-control" name="mrg_date" value="<?php echo "$mrg_date";?>"></div>
									</div>
									</div></br><hr> </br><!-- /box 4 -->
									...
									<div class="col-md-9"><input class="form-control" name="contact" value="<?php echo "$p";?>"></div>
									</div>
									
									<div class="col-lg-6">
									<div class="col-lg-3"><label class="text-center">Emergency Contact</label></div>
									<div class="col-lg-9"><input class="form-control" name="emecontact" value="<?php echo "$p1";?>"></div>
									</div>
									</div></br>
									...
									<div class="col-md-9"><input class="form-control" name="email" value="<?php echo "$q";?>"></div>
									</div>
									</div></br><hr>
									<div class="row">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
		  <div>
		  <div id="imagePreview" style="margin-left:200px;"><img src="off_reg_imgs/<?php echo $image;?>" alt="Player-Image" width="180" height="180"/></div>
		  <div id="manageleft">
