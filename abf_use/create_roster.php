...
$state_abb = $form->get_state_abb($state);
$roster_id = $state_abb . "-roster" . $random_id;
$enc_roster_id = base64_encode($roster_id);
$status = 0;
$sql = "INSERT INTO abfi_roster_create(player_reg_id,roster_id,event_id,state,gender,status) VALUES ('$selected','$roster_id','$event','$state','$gender','$status')";
