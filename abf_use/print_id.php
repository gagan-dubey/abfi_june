...
<title>Home | ABFI |  <?php echo $form->get_state_name($state);?>  | ID-CARDS | PLAYERS</title>
...
<?php 
$sql1 = "SELECT a.player_reg_id AS reg_id, b.full_name AS name, b.father_name AS father, b.dob AS dob, b.ply_img as image, b.position as position, b.blood_group as blood, b.emergency_contct as econtact, a.status as status, c.event_dates as dates FROM abfi_roster_create AS a
