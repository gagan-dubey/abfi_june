                ...
                <div class="col-lg-12">
                    ...
                    <p><button style="width:30px; height:25px;" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#myModal"><i class="fa fa-image fa-fw"></i></button>
                              ...
                              <img src="../abf_use/off_reg_imgs/<?php echo $image;?>" alt="Player-Image" width="150" height="150"/>
									...
									<div class="col-lg-5"><input class="form-control" name="blood" value="<?php echo "$f";?>" required></div>
									</div>
									...
									<div class="col-md-10"><textarea class="form-control" name="address" rows="6" style="resize: none;" required><?php echo "$i";?></textarea></div>
									</div>
									<div class="col-md-6">
											<div class="row">
											<div class="col-md-3"><label>District</label></div>
											<div class="col-md-7"><input class="form-control" name="district" value="<?php echo "$k";?>" required></div>
											</div></br>
											
											<div class="row">
											<div class="col-md-3"><label>State</label></div>
											<div class="col-md-7"><input class="form-control" value="<?php echo $single_ply_dets->get_state_name($l);?>" readonly></div>
											</div></br>
											
											<div class="row">
											<div class="col-md-3"><label>Post code</label></div>
											<div class="col-md-7"><input class="form-control" name="postalcode" value="<?php echo "$j";?>" required></div>
											</div>
									...
									<div class="col-lg-8"><input class="form-control" name="passport" value="<?php echo "$o";?>" required></div>
									</div>
									...
									<div class="col-md-9"><input class="form-control" name="contact" value="<?php echo "$p";?>" required></div>
									</div>
									
									<div class="col-lg-6">
									<div class="col-lg-3"><label class="text-center">Emergency Contact</label></div>
									<div class="col-lg-9"><input class="form-control" name="emecontact" value="<?php echo "$p1";?>" required></div>
									</div>
									</div></br>
									...
									<div class="col-md-9"><input class="form-control" name="email" value="<?php echo "$q";?>" required></div>
									</div>
									</div></br><hr>
									<div class="row">
