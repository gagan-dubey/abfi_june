...
$code = $form->get_state_abb($stateid);
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="card wizard-card" data-color="blue" id="wizardProfile">
                    <form action="" method="POST" id="defaultForm" enctype="multipart/form-data">
                    	...
                    	<div class="wizard-header">
                        	<h3>
                        	   <small>New Player Registration</small>
                        	</h3>
                    	</div>
                            ...
                            <div class="tab-pane" id="address">
								...
								<div class="col-sm-3 col-sm-offset-1">
								 <div class="form-group">
                                            ...
                                            <input name="position" type="text" class="form-control" placeholder="Player Position" required>
                                          </div>
...
if(isset($_POST["finish"]))
{
	...
	$ply_id = $form->check_id_before_create($code,$ply_id_one,$gender);
	$sec_ply_id = $code . "PLY" . rand(10,10000) . $gender;
	...
	if($image_input == 4)
	{
		$empty_check = $form->check_all_fields_ply($file_name,$fullname,$fathername,$dob,$gender,$blood,$height,$weight,$address,$district,$state,$postcode,$contact,$emecontact,$email,$position,$aadhar,$passport);
		
		if($empty_check == 1)
		{
			$insert_data = $form->insert_player($ply_id,$sec_ply_id,$fullname,$fathername,$dob,$gender,$blood,$height,$weight,$address,$postcode,$district,$state,$login_state,$position,$aadhar,$passport,$contact,$emecontact,$email,$file_name,$status);
			if($insert_data)
			{
