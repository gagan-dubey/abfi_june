...
<a href='int_event_print_off_id?<?php echo"eve=$event1&rid=$roster1";?>'><button> Next <i class='fa fa-arrow-circle-right fa-fw'></i></button></a>
</div>
<div id="main">
...
<?php 
$sql1 = "SELECT a.ply_id AS reg_id, a.ply_name AS name, a.ply_dob AS dob, a.ply_country as country, a.ply_img as img, a.ply_position as position, a.ply_bloodg as blood, a.status as status, c.event_dates as dates FROM intn_eve_ply_roster AS a
