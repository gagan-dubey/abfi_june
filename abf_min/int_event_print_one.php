...
$sql_gender = "select distinct gender from intn_eve_ply_roster where roster_id = '$roster'";
           ...
           <div class="row">
                <div class="col-lg-12" style="margin-left:-100px;" id="page">
                    <div class="panel panel-default" style="border:none;">
                        <div class="panel-heading text-center" style="border-bottom:2px solid black;">
						...
						while($row = mysqli_fetch_assoc($result1)) {
								...
								echo" <div class='col-md-6' style='padding-top:18px; padding-bottom:18px;'>
									<div class='col-md-4'>
                    ...
                    <!-- /.panel -->
									...
									echo
									"<div class='row'>
									<center><a href='int_event_print_one?eve=$event1&rid=$roster1' class='btn btn-primary disabled'><i class='fa fa-arrow-circle-left fa-fw'></i> Back</a>
									<a href='int_event_print_four?eve=$event1&rid=$roster1' class='btn btn-primary'> Next <i class='fa fa-arrow-circle-right fa-fw'></i></a>
									</div>";
