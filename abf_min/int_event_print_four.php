           ...
           <div class="row">
                <div class="col-lg-12" style="margin-left:-100px;" id="page">
                    ...
                    <!-- /.panel -->
									...
									<center><a href='int_event_print_one?eve=$event1&rid=$roster1' class='btn btn-primary'><i class='fa fa-arrow-circle-left fa-fw'></i> Back</a>
									<a href='int_event_print_four?eve=$event1&rid=$roster1' class='btn btn-primary disabled'> Next <i class='fa fa-arrow-circle-right fa-fw'></i></a>
									</div> <hr>";
