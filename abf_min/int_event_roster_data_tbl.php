           ...
           <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<?php
						$roster = $form->get_international_roster_event($event);
						...
						while($row = mysqli_fetch_assoc($roster)) {
								...
								$f =base64_encode($row["country"]);
								$g =base64_encode($row["roster"]);
								$h = $form->get_country_name($row["country"]);
								if($b==0 || $a == null)
								{
								...
								echo "	 <tr class='gradeA'>
                                        ...
                                        <td>$b</td>
										<td>$d</td>
                                        <td><a href='int_event_roster_view?eve=$a1&rid=$g&cou=$f' class='btn btn-sm btn-primary'><i class='fa fa-eye fa-fw'></i> View Details</a></td>
