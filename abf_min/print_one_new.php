...
$sql_gender = "select distinct gender from abfi_roster_create where roster_id = '$roster'";
...
<title>ABFI | Roster Form |  <?php echo $form->get_state_name($state);?>  | Players</title>
           ...
           <div class="row">
                <div class="col-lg-12" style="margin-left:-100px;" id="page">
                    ...
                    <!-- /.panel -->
									...
									echo
									"<div class='row'>
									<center><a href='print_one_new?eve=$event1&rid=$roster1' class='btn btn-primary disabled'><i class='fa fa-arrow-circle-left fa-fw'></i> Back</a>
									<a href='print_four_new?eve=$event1&rid=$roster1&sta=$state1' class='btn btn-primary'> Next <i class='fa fa-arrow-circle-right fa-fw'></i></a>
									</div>";
