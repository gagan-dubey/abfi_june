           ...
           <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<?php
						$roster = $form->get_roster_by_event_intn();
						...
						while($row = mysqli_fetch_assoc($roster)) {
								...
								echo "	 <tr class='gradeA'>
										...
										<td>$e</td>
										<td>$f</td>
                                        <td><a href='int_event_roster_data_tbl?eve=$a1' class='btn btn-sm btn-primary'><i class='fa fa-eye fa-fw'></i> View Details</a></td>
