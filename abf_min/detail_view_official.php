                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
									...
									<div class="row">
									<center>
									<a href="<?php echo "edit_view_official?secid=$s";?>" class="btn btn-primary"><i class="fa fa-pencil-square-o fa-fw"></i> EDIT DETAILS</a>
									<?php if($m != 201)
									{echo "<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal'><i class='fa fa-trash-o fa-fw'></i> DELETE OFFICIAL</button>";}
									?>
									</center>
									</div>
