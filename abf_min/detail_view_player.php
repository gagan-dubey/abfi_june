		    ...
		    <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
									...
									<div class="col-md-12">
											...
											<div class="col-md-8"><input class="form-control" placeholder="dd/mm/yyyy" value="<?php echo "$d";?>" readonly ></div>
											</div>
									<hr>
									</div>
									</div>
									...
									<div class="col-md-8"><input class="form-control" value="<?php echo "$f";?>" readonly ></div>
									</div><br>
									...
									<div class="col-md-8"><input class="form-control" value="<?php echo "$m";?>" readonly ></div>
									</div></br>
									...
									<div class="col-md-8"><input class="form-control" value="<?php echo "$o";?>" readonly ></div>
									</div></div>
									...
									<div class="row">
									<div class="col-md-2"><label class="text-center">Emergency Contact</label></div>
									<div class="col-md-8"><input class="form-control" value="<?php echo "$p1";?>" readonly ></div>
									</div>
									</br>
									...
									<div class="row">
									<center><a href="<?php echo "edit_view_player?secid=$r";?>" class="btn btn-primary"><i class="fa fa-pencil-square-o fa-fw"></i> EDIT DETAILS</a>
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-trash-o fa-fw"></i> DELETE PLAYER</button>
									<?php
									if($status == 0)
									{
									echo "<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal1'><i class='fa fa-ban fa-fw'></i> BLOCK PLAYER</button></center>";
									}
									elseif($status == 2)
									{
									echo "<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal2'><i class='fa fa-check fa-fw'></i> UNBLOCK PLAYER</button></center>";
									}
									?>
									</div>
                     ...
                     <button type="button" class="close" data-dismiss="modal">&times;</button>
                       <h4 class="modal-title text-center">Delete Player</h4>
                                  </div>
					...
					if(isset($_POST['delete']))
					{
						...
						$delete_player = $del_player->delete_player($del);
						
						if($delete_player)
						{
						  echo "<script>alert('Player Deleted Successfully...');</script>";		
						  header( "refresh:0;url=all_player_data_tbl" );
						}
					}
					?>
                         </div>
					...
					<div class="modal fade" id="myModal1" role="dialog">
                            <div class="modal-dialog">
                              ...
                              <div class="modal-header">
                     <button type="button" class="close" data-dismiss="modal">&times;</button>
                       <h4 class="modal-title text-center">Block Player</h4>
                                  </div>
                            <div class="modal-body text-center">
							<p><i class="fa fa-exclamation-circle fa-3x"></i></p>
                          <p><b>Are you sure you want to block this player?</b></p>
						  <form method="post" action="">
						  <input type="hidden" value="<?php echo $r;?>" name="blk_play"/>
						  
                               </div>
                       <div class="modal-footer">
                    <center>
					<button type="submit" class="btn btn-success" name="block"><i class="fa fa-check-circle fa-fw"></i> Yes</button>
					<button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times-circle fa-fw"></i> No</button>
					</center>
					</form>
					<?php
					...
					{
						$del = base64_decode($_POST['blk_play']);
						$del_player = new abfi_admin();
						$delete_player = $del_player->block_player($del);
						
						if($delete_player)
						{
						  echo "<script>alert('Player Blocked Successfully...');</script>";	
						  header( "refresh:0;url=all_player_data_tbl" );
						}
					}
					?>
						...
						<div class="modal fade" id="myModal2" role="dialog">
                            <div class="modal-dialog">
                              ...
                              <div class="modal-header">
                     <button type="button" class="close" data-dismiss="modal">&times;</button>
                       <h4 class="modal-title text-center">Unblock Player</h4>
                                  </div>
                            <div class="modal-body text-center">
							<p><i class="fa fa-exclamation-circle fa-3x"></i></p>
                          <p><b>Are you sure you want to unblock this player?</b></p>
						  <form method="post" action="">
						  <input type="hidden" value="<?php echo $r;?>" name="ublk_play"/>
						  
                               </div>
                       <div class="modal-footer">
                    <center>
					<button type="submit" class="btn btn-success" name="unblock"><i class="fa fa-check-circle fa-fw"></i> Yes</button>
					<button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-times-circle fa-fw"></i> No</button>
					</center>
					</form>
					<?php
					...
					{
						$del = base64_decode($_POST['ublk_play']);
						$del_player = new abfi_admin();
						$delete_player = $del_player->unblock_player($del);
						
						if($delete_player)
						{
						  echo "<script>alert('Player Unblocked Successfully...');</script>";		
						  header( "refresh:0;url=all_player_data_tbl" );
						}
					}
					?>
