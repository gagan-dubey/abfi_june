...
<title>ABFI | Roster Form | <?php echo $form->get_state_name($state);?> | Officials</title>
           ...
           <div class="row">
                <div class="col-lg-12" style="margin-left:-100px;" id="page">
                    ...
                    <!-- /.panel -->
									...
									<center><a href='print_one_new?eve=$event1&rid=$roster1&sta=$state1' class='btn btn-primary'><i class='fa fa-arrow-circle-left fa-fw'></i> Back</a>
									<a href='print_four_new?eve=$event1&rid=$roster1' class='btn btn-primary disabled'> Next <i class='fa fa-arrow-circle-right fa-fw'></i></a>
									</div> <hr>";
