           ...
           <div class="row">
                <div class="col-lg-12" style="margin-left:-100px;" id="page">
                    <div class="panel panel-default" style="border:none;">
                        ...
                        <div class="panel-body">
								...
								<?php 
									$sql1 = "SELECT a.player_reg_id AS reg_id, b.full_name AS name, b.father_name AS father, b.dob AS dob, b.ply_img as image, a.status as status FROM int_roster_ply AS a
											INNER JOIN abfi_ply_reg AS b ON a.player_reg_id = b.ply_reg_id where a.roster_id = '$roster' and a.event_id = '$event' limit 24,26";
						...
						while($row = mysqli_fetch_assoc($result1)) {
								...
								echo" <div class='col-md-6' style='padding-top:20px;'>
									<div class='col-md-4'>
									<center><img src='../abf_use/off_reg_imgs/$e' class='img-thumbnail'  width='130' height='130'></center>
									</div>
									<div class='col-md-8'>
											<div class='row'>
											...
											<div class='col-md-8'><label>$b</label></div>
											</div>
                    ...
                    <!-- /.panel -->
									...
									echo
									"<div class='row'>
									<center><a href='print_two?eve=$event1&rid=$roster1' class='btn btn-primary'><i class='fa fa-arrow-circle-left fa-fw'></i> Back</a>
									<a href='print_four?eve=$event1&rid=$roster1' class='btn btn-primary'> Next <i class='fa fa-arrow-circle-right fa-fw'></i></button></a>
									</div> <hr>";
