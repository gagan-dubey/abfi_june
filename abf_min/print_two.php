           ...
           <div class="row">
                <div class="col-lg-12" style="margin-left:-100px;" id="page">
                        ...
                        <div class="panel-body">
								...
								<?php 
									$sql1 = "SELECT a.player_reg_id AS reg_id, b.full_name AS name, b.father_name AS father, b.dob AS dob, b.ply_img as image, a.status as status FROM int_roster_ply AS a
											INNER JOIN abfi_ply_reg AS b ON a.player_reg_id = b.ply_reg_id where a.roster_id = '$roster' and a.event_id = '$event' limit 12 OFFSET 12";
                    ...
                    <!-- /.panel -->
									...
									<a href='print_three?eve=$event1&rid=$roster1' class='btn btn-primary'> Next <i class='fa fa-arrow-circle-right fa-fw'></i></button></a>
									</div> <hr>";
